 ...
 * Date: 2016-04-26
 */
public class AirAdapter extends BaseRecyclerAdapter<Task> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_airs,null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        taskHolder.simpleDraweeView.setAspectRatio(0.7f);
