...
public class MyPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link MyPlayer#onRenderers}
         *     should be invoked once the renderers have been built. If building fails,
         *     {@link MyPlayer#onRenderersError} should be invoked.
         */
        void buildRenderers(MyPlayer player);
        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p>
         * A canceled build operation must not invoke {@link MyPlayer#onRenderers} or
         * {@link MyPlayer#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
