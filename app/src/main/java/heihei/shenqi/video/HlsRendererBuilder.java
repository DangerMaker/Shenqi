...
/**
 * A {@link MyPlayer.RendererBuilder} for HLS.
 */
public class HlsRendererBuilder implements MyPlayer.RendererBuilder {
  ...
  @Override
  public void buildRenderers(MyPlayer player) {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, MyPlayer player) {
      this.context = context;
      this.userAgent = userAgent;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MyPlayer.TYPE_VIDEO);
      ...
      if (haveSubtitles) {
        ...
        HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MyPlayer.TYPE_TEXT);
      ...
      renderers[MyPlayer.TYPE_METADATA] = id3Renderer;
